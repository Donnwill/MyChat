...
import 'package:my_chat/pages/tabPages/add_users.dart';
import 'package:my_chat/pages/tabPages/search_users.dart';
...
class _RequestsTabState extends State<RequestsTab> {
  ...
  showSearchList(bool isActive) {
    setState(() {
      searchUsers = isActive;
    });

    print(searchUsers);
  }

  getSearchedUserName(String userName) {
    setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: Column(
          children: [
            SearchUser(showSearchList, getSearchedUserName),
            (searchUsers != true)
                ? (requestLength >= 1)
                    ? Expanded(
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                            ...
                                            child: Ink(
                                              decoration: BoxDecoration(
                                                  gradient: const LinearGradient(
                                                      colors: [Color(0xffDC1C13), Color(0xffF1959B)]),
                                                  borderRadius: BorderRadius.circular(15)),
                                              child: Container(
                                                width: 75,
                                                height: 35,
